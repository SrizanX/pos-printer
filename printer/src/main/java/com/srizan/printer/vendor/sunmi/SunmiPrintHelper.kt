...
class SunmiPrintHelper {
     ...
     * @author: Monir
     */
    fun printTableWithStyleText (
        textsStringArray: Array<String>,
        widthIntArray: IntArray,
        alignIntArray: IntArray,
        size: Float,
        isBold: Boolean,
        ...
        try {
            sunmiPrinterService!!.printColumnsString(textsStringArray, widthIntArray, alignIntArray, null)
     ...
     * Print a row of a table
     */
    fun printTable(textArrayString: Array<String?>?, widthIntArray: IntArray?, alignIntArray: IntArray?) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return
        }
        try {
            sunmiPrinterService!!.printColumnsString(textArrayString, widthIntArray, alignIntArray, null)
        } catch (e: RemoteException) {
            e.printStackTrace()
        }
    }
     ...
     * printing
     */
    fun hasPrinterStatus(application: Application):Boolean {
        if (sunmiPrinterService == null) {
    ...
    fun Application.showToastMessage(message:String){
